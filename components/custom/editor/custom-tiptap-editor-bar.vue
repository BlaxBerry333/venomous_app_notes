...
<template>
  ...
  >
    ...
    >
      ...
      <v-menu activator="parent">
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('bold') })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('italic') })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('strike') })"
        >
    ...
    >
      ...
      <v-menu activator="parent">
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('paragraph') })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { slevel: 1 }) })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { level: 2 }) })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { level: 3 }) })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { level: 4 }) })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { level: 5 }) })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('heading', { level: 6 }) })"
        >
    ...
    >
      ...
      <v-menu activator="parent">
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('bulletList') })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('orderedList') })"
        >
    ...
    >
      ...
      <v-menu activator="parent">
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('code') })"
        >
        ...
        <v-btn
          ...
          :class="clsx({ 'is-active': editor.isActive('blockquote') })"
        >
    ...
    <v-btn
      ...
      :class="clsx({ 'is-disabled': !editor.can().chain().focus().undo().run() })"
      :style="{ margin: '3px' }"
    />
    <v-btn
      variant="elevated"
      ...
      :class="clsx({ 'is-disabled': !editor.can().chain().focus().redo().run() })"
      :style="{ margin: '3px' }"
    />
  </div>
</template>
